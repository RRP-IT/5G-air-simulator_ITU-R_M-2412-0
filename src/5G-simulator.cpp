 ...
 *  g.piro@poliba.it
 *
 * For this version contact the author at
 *<rrp@lx.it.pt>
 *
 */
...
#include "scenarios/single-cell-with-interference_UMi_A_LoS.h"
  ...
  if (argc > 1)
    {
      ...
      if (strcmp(argv[1], "SingleCellWithIUMiALoS")==0)
              {
                SingleCellWithInterferenceUMiALoS (argc, argv);
              }
