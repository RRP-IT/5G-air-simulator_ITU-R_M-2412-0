                                     ...
                                     Cell* cell, GNodeB* gnb)
{
  ...
  ChannelRealization* c_dl = new ChannelRealization (gnb, ue, ChannelRealization::CHANNEL_MODEL_MICROCELL_URBAN_A_IMT_3D);
  gnb->GetPhy()->GetDlChannel ()->GetPropagationLossModel ()->AddChannelRealization (c_dl);
  if (gnb->GetPhy()->GetDlMcChannel () != nullptr)
    {
      ChannelRealization* c_mcdl = new ChannelRealization (gnb, ue, ChannelRealization::CHANNEL_MODEL_MICROCELL_URBAN_A_IMT_3D, true);
      gnb->GetPhy()->GetDlMcChannel ()->GetPropagationLossModel ()->AddChannelRealization (c_mcdl);
    }
  ChannelRealization* c_ul = new ChannelRealization (ue, gnb, ChannelRealization::CHANNEL_MODEL_MICROCELL_URBAN_A_IMT_3D);
