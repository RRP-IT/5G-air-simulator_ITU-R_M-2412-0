...
*/
// For 2.6 GHz  -> remove comments from this section and comment the sections below
...
#define DL_HIGH_FREQUENCY_BAND_1 2690 	//MHz
 ...
 //For  3.5 GHz -> remove comments from this section and comment the sections below
...
*/
 ...
 // For  5.62 GHz -> remove comments from this section and comment the sections below
/*
 #define UL_LOW_FREQUENCY_BAND_1 5150 	//MHz
 #define UL_HIGH_FREQUENCY_BAND_1 5270 	//MHz
 #define DL_LOW_FREQUENCY_BAND_1 5805 	//MHz
